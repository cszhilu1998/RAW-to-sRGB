...
# The network structure of SRResNet is consistent with "Zoom to Learn, Learn to Zoom"
# Borrow the code from https://github.com/ceciliavision/zoom-learn-zoom/blob/master/net.py
