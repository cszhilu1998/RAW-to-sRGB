...
class ZRRGANModel(BaseModel):
	...
	def __init__(self, opt):
		...
		self.opt = opt
		self.loss_names = ['GCMModel_L1', 'LiteISPGAN_L1', 'LiteISPGAN_SSIM', 'LiteISPGAN_VGG', 'LiteISPGAN_GAN', 'Total_G', 'Total_D']
	...
	def backward_G(self):
		...
		self.loss_Total = self.loss_GCMModel_L1 + self.loss_ISPNet_L1 + self.loss_ISPNet_VGG \
