...
class ISPJOINTGANModel(BaseModel):
	@staticmethod
	def modify_commandline_options(parser, is_train=True):
		return parser

	def __init__(self, opt):
		super(ISPJOINTGANModel, self).__init__(opt)
		
		self.opt = opt
		self.loss_names = ['AlignNet_L1', 'ISPNet_L1', 'ISPNet_SSIM', 'ISPNet_VGG', 'ISPNet_GAN', 'Total', 'Total_D']
