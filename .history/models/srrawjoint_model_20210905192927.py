...
class SRRAWJOINTModel(BaseModel):
	...
	def __init__(self, opt):
		...
		isp = SRResNet(opt)
		self.netSRResNet= N.init_net(isp, opt.init_type, opt.init_gain, opt.gpu_ids)

		align = zrrjoint_model.GCMModel(opt)
		...
		if self.isTrain:		
			...
			self.optimizers = [self.optimizer_SRResNet, self.optimizer_GCMModel] #  , self.optimizer_D
