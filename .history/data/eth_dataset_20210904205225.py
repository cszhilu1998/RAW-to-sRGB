...
def imreader(arg):
	# Due to the memory (32 GB) limitation, here we only preload the raw image. 
	# If you have enough memory, you can also modify the #code here to load the sRGB image"
	i, obj = arg
	for _ in range(3):
		try:
