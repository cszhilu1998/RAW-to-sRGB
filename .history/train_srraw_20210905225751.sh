...
python train.py \
    ...
    --batch_size 8           --print_freq 100   --calc_metrics True   --lr 1e-4   -j 8  \
    --dataroot $dataroot      --scale 1   | tee $LOG    

# x2 Super-Resolution
python train.py \
    --dataset_name srraw      --model srrawjoint      --name $name           --gcm_coord True  \
    --pre_ispnet_coord False  --niter 4        --lr_decay_iters 4   --save_imgs False \
    --batch_size 8           --print_freq 100   --calc_metrics True    --lr 1e-4   -j 8  \
...
python train.py \
    --dataset_name srraw      --model srrawjoint      --name $name           --gcm_coord True  \
    --pre_ispnet_coord False  --niter 8        --lr_decay_iters 6   --save_imgs False \
    --batch_size 8           --print_freq 100   --calc_metrics True    --lr 5e-5   -j 8  \
    --dataroot $dataroot      --scale 4          --load_iter 4  | tee $LOG   
