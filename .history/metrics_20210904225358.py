...
def calc_metrics(x_mask_out, x_canon, loss_fn_alex_0, loss_fn_alex_1):
	...
	return [psnr, SSIM, LPIPS_0, LPIPS_1]
...
if __name__ == '__main__':
	...
	files = [
		...
		'/home/zzl/Code/ISP/AdaISP/AdaISP_rebuttal/ckpt/ispjoint_gamma_precoord/'
	...
	for file in files:
		...
		for name in tqdm(names): 
			...
			x_out = cv2.imread(file + 'visual_test_1204/' + name + '.png')[..., ::-1]
			...
			ori_metrics[i, 0:4] = calc_metrics(x_out, test_canon[i], loss_fn_alex_0, loss_fn_alex_1)
